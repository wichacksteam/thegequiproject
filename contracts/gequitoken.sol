...
contract CreditToken is GequiCredits,ERC20{
    uint totalsupply;
    uint supply;
    ...
    function createGequiToken() public onlyCreditHolder() returns(uint) {
    ...
    function buyGequiCredits(uint amount) public payable {
        uint value = amount * 1;
        require(msg.value > 0);
